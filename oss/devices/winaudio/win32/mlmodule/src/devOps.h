...
extern MLstatus waveDeviceOpen( AudioPath* path, WAVEFORMATEX* inFormat );
extern MLstatus waveDeviceClose( AudioPath* path );
extern MLstatus getAudioPathControls( AudioPath* path, MLpv *msg );
extern MLstatus setAudioPathControls( AudioPath* path, MLpv* msg );
