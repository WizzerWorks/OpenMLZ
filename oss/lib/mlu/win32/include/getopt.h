...
#ifdef MLGLOBAL_EXPORTS
#define MLGLOBAL_API __declspec(dllexport)
#else
#define MLGLOBAL_API __declspec(dllimport)
#endif

extern MLGLOBAL_API int nMLGLOBAL;

extern MLGLOBAL_API int optind;
extern MLGLOBAL_API char* optarg;
